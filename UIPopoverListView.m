...
- (void)defalutInit
{
    ...
    _titleView.backgroundColor =[UIColor colorWithHex:0x3D89BF];
    ...
    CGRect tableFrame = CGRectMake(0, 32.0f, xWidth, self.bounds.size.height-64.0f);
    _listView = [[UITableView alloc] initWithFrame:tableFrame style:UITableViewStylePlain];
    _listView.dataSource = self;
    _listView.delegate = self;
    _listView.backgroundView=[[[UIView alloc] initWithFrame:_listView.frame] autorelease];
    [_listView.backgroundView setBackgroundColor:[UIColor whiteColor]];
    [self addSubview:_listView];
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
     button.backgroundColor=[UIColor colorWithHex:0x3D89BF];
    button.frame = CGRectMake(0,self.bounds.size.height-32 , xWidth, 32);
