...
@synthesize realTimeMessageViewController = _realTimeMessageViewController;
...
- (void)dealloc {
	[_realTimeMessageViewController release];
...
//    self.realTimeMessageViewController.phraseString = faceStr;
//    [self.realTimeMessageViewController.messageString appendString:self.realTimeMessageViewController.phraseString];
    [self dismissModalViewControllerAnimated:YES];
}
