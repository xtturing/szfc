...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row%2==0){
        [button setImage:[UIImage imageNamed:@"have_foucs.png"] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:@"have_foucs.png"] forState:UIControlStateHighlighted];
    }else {
